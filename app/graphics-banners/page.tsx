            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-white/80 max-w-3xl mx-auto">
                  Elevate your social media presence with professional profile banners, post graphics, and story designs from talented Fiverr freelancers.
                </p>
              </div>
              ...
              <div className="text-center max-w-3xl mx-auto">
                <div className="glass rounded-2xl p-8 border border-white/10">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
                    Ready to Get Your Professional Social Media Graphics & Banners?
                  </h2>
                  <p className="text-white/80 mb-6">
                    Browse hundreds of top-rated Social Media Graphics & Banners gigs and find the perfect designer for your brand.
                  </p>
                  <a
