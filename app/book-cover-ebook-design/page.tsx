            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-white/80 max-w-3xl mx-auto">
                  Sell more books with compelling, genre-specific book cover and eBook designs crafted by professional Fiverr designers.
                </p>
              </div>
              ...
              <div className="text-center max-w-3xl mx-auto">
                <div className="glass rounded-2xl p-8 border border-white/10">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
                    Get Your Professional Book Cover & eBook Design
                  </h2>
                  <p className="text-white/80 mb-6">
                    Browse hundreds of top-rated Book Cover & eBook Design.
                  </p>
                  <a
                  ...
                  >
                    Explore Book Cover & eBook Design
