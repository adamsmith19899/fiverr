            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-white/80 max-w-3xl mx-auto">
                  Bring your creative project to life with custom SVG files, cutting patterns, and craft templates designed by Fiverr's talented sellers.
                </p>
              </div>
              ...
              <div className="text-center max-w-3xl mx-auto">
                <div className="glass rounded-2xl p-8 border border-white/10">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
                    Get DIY & Craft Design Services
                  </h2>
                  <p className="text-white/80 mb-6">
                    Browse hundreds of top-rated DIY & Craft Design Services Gigs.
                  </p>
                  <a
                  ...
                  >
                    Explore DIY & Craft Design Services Gigs
