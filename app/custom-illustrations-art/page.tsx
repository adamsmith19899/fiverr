            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-white/80 max-w-3xl mx-auto">
                  Receive unique and personalized digital illustrations, character designs, and artwork from skilled Fiverr artists for any project.
                </p>
              </div>
              ...
              <div className="text-center max-w-3xl mx-auto">
                <div className="glass rounded-2xl p-8 border border-white/10">
                  ...
                  <p className="text-white/80 mb-6">
                    Browse hundreds of top-rated Custom Illustrations & Art Gigs.
                  </p>
                  <a
                  ...
                  >
                    Explore Custom Illustrations & Art Gigs
