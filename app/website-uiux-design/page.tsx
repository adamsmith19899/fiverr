            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-white/80 max-w-3xl mx-auto">
                  Launch a stunning and user-friendly website with custom UI/UX design, wireframing, and prototyping services from top-rated Fiverr experts.
                </p>
              </div>
              ...
              <div className="text-center max-w-3xl mx-auto">
                <div className="glass rounded-2xl p-8 border border-white/10">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
                    Get Your Professional Website & UI/UX Design
                  </h2>
                  <p className="text-white/80 mb-6">
                    Browse hundreds of top-rated Website & UI/UX Design Gigs.
                  </p>
                  <a
                  ...
                  >
                    Explore Website & UI/UX Design Gigs
